...
const sliderKomfort = document.querySelector(".slider-komfort");

if(sliderKomfort) {
  const swiperKomfort = new Swiper(sliderKomfort, { 
    observer: true,
    observeParents: true,
    watchOverflow: true,
    slidesPerView: "auto",
    ...
    pagination: {
      el: '.slider-komfort-pagination',
      clickable: true, 
    },
    navigation: {
      nextEl: '.slider-komfort-next',
      prevEl: '.slider-komfort-prev',
    }, 
  });
}

const sliderEssen = document.querySelector(".slider-essen");

if(sliderKomfort) {
  const swiperrEssen = new Swiper(sliderEssen, { 
    observer: true,
    observeParents: true,
    watchOverflow: true,
    slidesPerView: "auto",
    ...
    direction: 'horizontal', 
    pagination: {
      el: '.slider-essen-pagination',
      clickable: true, 
    },
    navigation: {
      nextEl: '.slider-essen-next',
      prevEl: '.slider-essen-prev',
    }, 
  });
}
...
document.addEventListener("click", function (e) {
  ...
  if (elementInteractive.closest(".reg-btn")) {
    if (popupForm) {
      popupForm.classList.add("active");
      popupForm.querySelector(".form-reg").classList.add("active-form");
    }
  }
  if (elementInteractive.closest(".log-btn")) {
    popupForm.classList.add("active");
    popupForm.querySelector(".form-log").classList.add("active-form");
  }
  if (elementInteractive.closest(".popup-form-close")) {
    popupForm.classList.remove("active");
    popupForm.querySelector(".form-reg").classList.remove("active-form");
    popupForm.querySelector(".form-log").classList.remove("active-form");
  }
})

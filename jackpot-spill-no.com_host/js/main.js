...
const overSlider = document.querySelector(".over-slider");

if (overSlider) {
  const overSwiper = new Swiper(overSlider, {
    observer: true,
    observeParents: true,
    watchOverflow: true,
    slidesPerView: "auto",
    ...
    pagination: {
      el: '.over-slider-pagination',
      clickable: true,
    },
    navigation: {
      nextEl: '.over-slider-next',
      prevEl: '.over-slider-prev',
    },
  });
}
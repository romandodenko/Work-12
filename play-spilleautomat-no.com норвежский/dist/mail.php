...
try {
  ...
  $mail->Username   = 'patri@gmail.com'; // Логин на почте , если использовать yandex то нужно указывать логин, а не всю почту
  $mail->Password   = 'ctsbulhgqsrjzvur'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

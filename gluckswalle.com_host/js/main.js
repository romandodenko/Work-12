...
const footerTopLeft = document.querySelector(".footer__top-left");

const icons = document.querySelector(".icons");

if (footerTopLeft && icons) {
  if (document.body.clientWidth < 992) {
    footerTopLeft.append(icons);
  }
}

const restSlider = document.querySelector(".rest-slider");

if (restSlider) {
  const restSwiper = new Swiper(restSlider, {
    observer: true,
    observeParents: true,
    watchOverflow: true,
    slidesPerView: 'auto',
    ...
    pagination: {
      el: '.rest-slider-pagination',
      clickable: true,
    },
    navigation: {
      nextEl: '.rest-slider-next',
      prevEl: '.rest-slider-prev',
    },
  });
}